...
import (
	...
	base "github.com/EktaMind/Thank_Sirus/eventcheck/epochcheck"
...
type Reader interface {
	base.Reader
	GetEpochRules() (thankyoucoin.Rules, idx.Epoch)
}
...
func CalcGasPowerUsed(e inter.EventPayloadI, rules thankyoucoin.Rules) uint64 {
	txsGas := uint64(0)
...
func (v *Checker) checkGas(e inter.EventPayloadI, rules thankyoucoin.Rules) error {
...
func CheckTxs(txs types.Transactions, rules thankyoucoin.Rules) error {
	maxType := uint8(0)
