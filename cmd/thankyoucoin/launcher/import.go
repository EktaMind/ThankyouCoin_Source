...
import (
	...
	"github.com/kalibroida/ThankyouCoin_Node/utils/iodb"
	"github.com/kalibroida/ThankyouCoin_Node/utils/ioread"
)
...
func importEvents(ctx *cli.Context) error {
	...
	cfg := makeAllConfigs(ctx)
	cfg.Photon.Protocol.EventsSemaphoreLimit.Size = math.MaxUint32
	cfg.Photon.Protocol.EventsSemaphoreLimit.Num = math.MaxUint32
	cfg.Photon.Emitter.Validator = emitter.ValidatorConfig{}
	cfg.Photon.TxPool.Journal = ""
	cfg.Node.IPCPath = ""
	cfg.Node.HTTPHost = ""
	cfg.Node.WSHost = ""
	cfg.Node.NoUSB = true
