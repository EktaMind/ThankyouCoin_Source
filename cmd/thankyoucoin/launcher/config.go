...
import (
	...
	futils "github.com/kalibroida/ThankyouCoin_Node/utils"
...
var (
	...
	RPCGlobalGasCapFlag = cli.Uint64Flag{
		Name:  "rpc.gascap",
		Usage: "Sets a cap on gas that can be used in thx_call/estimateGas (0=infinite)",
		Value: gossip.DefaultConfig(cachescale.Identity).RPCGasCap,
	}
	RPCGlobalTxFeeCapFlag = cli.Float64Flag{
		Name:  "rpc.txfeecap",
		Usage: "Sets a cap on transaction fee (in THX) that can be sent via the RPC APIs (0 = no cap)",
		Value: gossip.DefaultConfig(cachescale.Identity).RPCTxFeeCap,
	}

	AllowedPhotonGenesisHashes = map[uint64]hash.Hash{
		thankyoucoin.MainNetworkID: hash.HexToHash("0x8895b98d25c653773a31be420a6a29d322a10107e76dff37dc694ad02ebacd01"),
		thankyoucoin.TestNetworkID: hash.HexToHash("0xc4a5fc96e575a16a9a0c7349d44dc4d0f602a54e0a8543360c2fee4c3937b49e"),
	}
)
...
func getPhotonGenesis(ctx *cli.Context) integration.InputGenesis {
	...
	case ctx.GlobalIsSet(FakeNetFlag.Name):
		...
		fakeGenesisStore := makegenesis.FakeGenesisStore(num, futils.ToThx(1000000000), futils.ToThx(5000000))
...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "eth", "thx", "dag", "sfc", "abft", "web3")
	cfg.WSModules = append(cfg.WSModules, "eth", "thx", "dag", "sfc", "abft", "web3")
	cfg.IPCPath = "thankyoucoin.ipc"
	cfg.DataDir = DefaultDataDir()
	return cfg
}
