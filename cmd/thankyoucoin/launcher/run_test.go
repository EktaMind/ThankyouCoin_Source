...
import (
	...
	"github.com/kalibroida/ThankyouCoin_Node/cmd/cmdtest"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "thankyoucoin-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "thankyoucoin-test" in exec().
	reexec.Register("thankyoucoin-test", func() {
...
func exec(t *testing.T, args ...string) *testcli {
	...
	// Boot "thankyoucoin". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("thankyoucoin-test", args...)
