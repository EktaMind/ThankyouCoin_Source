...
var (
	walletCommand = cli.Command{
		...
		Description: `
    thankyoucoin wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	thankyoucoin wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    thankyoucoin account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    thankyoucoin account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    thankyoucoin account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    thankyoucoin account import [options] <keyfile>
