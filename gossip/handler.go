...
import (
	...
	"github.com/EktaMind/Thank_Sirus/eventcheck/queuedcheck"
	"github.com/EktaMind/Thank_Sirus/gossip/dagprocessor"
	"github.com/EktaMind/Thank_Sirus/gossip/dagstream"
	"github.com/EktaMind/Thank_Sirus/gossip/dagstream/streamleecher"
	"github.com/EktaMind/Thank_Sirus/gossip/dagstream/streamseeder"
	"github.com/EktaMind/Thank_Sirus/gossip/itemsfetcher"
	"github.com/EktaMind/Thank_Sirus/hash"
	"github.com/EktaMind/Thank_Sirus/inter/dag"
	"github.com/EktaMind/Thank_Sirus/inter/idx"
	"github.com/EktaMind/Thank_Sirus/utils/datasemaphore"
	...
	"github.com/kalibroida/ThankyouCoin_Node/eventcheck/parentlesscheck"
...
// newHandler returns a new Techpay sub protocol manager. The Techpay sub protocol manages peers capable
// with the Techpay network.
func newHandler(
	c handlerConfig,
) (
	*ProtocolManager,
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping Techpay protocol")
	...
	log.Info("Techpay protocol stopped")
}
