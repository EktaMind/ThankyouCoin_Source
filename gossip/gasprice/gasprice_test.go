...
type TestBackend struct {
	...
	rules             thankyoucoin.Rules
	pendingRules      thankyoucoin.Rules
}
...
func (t TestBackend) GetRules() thankyoucoin.Rules {
	return t.rules
}

func (t TestBackend) GetPendingRules() thankyoucoin.Rules {
...
func TestSuggestPrice(t *testing.T) {
	backend := &TestBackend{
		block:             1,
		totalGasPowerLeft: 0,
		rules:             thankyoucoin.FakeNetRules(),
		pendingRules:      thankyoucoin.FakeNetRules(),
	}
