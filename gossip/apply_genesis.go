...
import (
	...
	"github.com/kalibroida/ThankyouCoin_Node/inter/drivertype"
	"github.com/kalibroida/ThankyouCoin_Node/thankyoucoin"
	"github.com/kalibroida/ThankyouCoin_Node/thankyoucoin/genesis"
)

// ApplyGenesis writes initial state.
func (s *Store) ApplyGenesis(blockProc BlockProc, g thankyoucoin.Genesis) (genesisHash hash.Hash, err error) {
...
func (s *Store) applyEpoch0Genesis(g thankyoucoin.Genesis) (evmBlock *evmcore.EvmBlock, err error) {
...
func (s *Store) applyEpoch1Genesis(blockProc BlockProc, g thankyoucoin.Genesis) (err error) {
	...
	prettyHash := func(root common.Hash, g thankyoucoin.Genesis) hash.Event {
