...
import (
	...
	"github.com/kalibroida/ThankyouCoin_Node/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/kalibroida/ThankyouCoin_Node/gossip/emitter External,TxPool,TxSigner,Signer
...
func TestEmitter(t *testing.T) {
	...
	t.Run("init", func(t *testing.T) {
		external.EXPECT().GetRules().
			Return(thankyoucoin.FakeNetRules()).
			AnyTimes()
