...
// Source: github.com/kalibroida/ThankyouCoin_Node/gossip/emitter (interfaces: External,TxPool,TxSigner,Signer)

// Package mock is a generated GoMock package.
package mock

import (
	evmcore "github.com/kalibroida/ThankyouCoin_Node/evmcore"
	inter "github.com/kalibroida/ThankyouCoin_Node/inter"
	validatorpk "github.com/kalibroida/ThankyouCoin_Node/inter/validatorpk"
	thankyoucoin "github.com/kalibroida/ThankyouCoin_Node/thankyoucoin"
	vecmt "github.com/kalibroida/ThankyouCoin_Node/vecmt"
	hash "github.com/EktaMind/Thank_Sirus/hash"
	idx "github.com/EktaMind/Thank_Sirus/inter/idx"
	pos "github.com/EktaMind/Thank_Sirus/inter/pos"
	common "github.com/EktaMind/Thank_ethereum/common"
	types "github.com/EktaMind/Thank_ethereum/core/types"
	event "github.com/EktaMind/Thank_ethereum/event"
...
func (m *MockExternal) GetRules() thankyoucoin.Rules {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRules")
	ret0, _ := ret[0].(thankyoucoin.Rules)
	return ret0
}
