...
import (
	...
	"github.com/EktaMind/Thank_Sirus/sirius"
	"github.com/EktaMind/Thank_Sirus/utils/workers"
	...
	"github.com/kalibroida/ThankyouCoin_Node/ethapi"
	"github.com/kalibroida/ThankyouCoin_Node/eventcheck"
	"github.com/kalibroida/ThankyouCoin_Node/eventcheck/basiccheck"
	"github.com/kalibroida/ThankyouCoin_Node/eventcheck/epochcheck"
	"github.com/kalibroida/ThankyouCoin_Node/eventcheck/gaspowercheck"
	"github.com/kalibroida/ThankyouCoin_Node/eventcheck/heavycheck"
	"github.com/kalibroida/ThankyouCoin_Node/eventcheck/parentscheck"
	"github.com/kalibroida/ThankyouCoin_Node/evmcore"
	"github.com/kalibroida/ThankyouCoin_Node/gossip/blockproc"
	"github.com/kalibroida/ThankyouCoin_Node/gossip/blockproc/drivermodule"
	"github.com/kalibroida/ThankyouCoin_Node/gossip/blockproc/eventmodule"
	"github.com/kalibroida/ThankyouCoin_Node/gossip/blockproc/evmmodule"
	"github.com/kalibroida/ThankyouCoin_Node/gossip/blockproc/sealmodule"
	"github.com/kalibroida/ThankyouCoin_Node/gossip/blockproc/verwatcher"
	"github.com/kalibroida/ThankyouCoin_Node/gossip/emitter"
	"github.com/kalibroida/ThankyouCoin_Node/gossip/filters"
	"github.com/kalibroida/ThankyouCoin_Node/gossip/gasprice"
	...
	"github.com/kalibroida/ThankyouCoin_Node/utils/gsignercache"
	"github.com/kalibroida/ThankyouCoin_Node/utils/wgmutex"
	"github.com/kalibroida/ThankyouCoin_Node/valkeystore"
...
func DefaultBlockProc(g thankyoucoin.Genesis) BlockProc {
	return BlockProc{
...
func newService(config Config, store *Store, signer valkeystore.SignerI, blockProc BlockProc, engine sirius.Consensus, dagIndexer *vecmt.Index) (*Service, error) {
	svc := &Service{
		config:             config,
...
// MakeProtocols constructs the P2P protocol definitions for `thankyoucoin`.
...
func (s *Service) Stop() error {
	defer log.Info("Techpay service stopped")
	s.verWatcher.Stop()
	close(s.done)
	s.emitter.Stop()
	s.pm.Stop()
